...
namespace vlr::shared {
    ...
    CUDA_DEVICE_FUNCTION CUDA_INLINE Point3D transform(const Point3D &p) {
    ...
    template <TransformKind kind>
    CUDA_DEVICE_FUNCTION CUDA_INLINE Vector3D transform(const Vector3D &v) {
        if constexpr (kind == TransformKind::ObjectToWorld)
    ...
    template <TransformKind kind>
    CUDA_DEVICE_FUNCTION CUDA_INLINE Normal3D transform(const Normal3D &n) {
        if constexpr (kind == TransformKind::ObjectToWorld)
    ...
    struct GeometryInstance {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE GeometryInstance() {}
    ...
    struct Instance {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE Instance() {}
    };
    ...
    struct ReferenceFrame {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE ReferenceFrame(const Vector3D &t, const Normal3D &n) :
            x(t), y(cross(n, t)), z(n) { }
        CUDA_DEVICE_FUNCTION CUDA_INLINE ReferenceFrame(const Vector3D &t, const Vector3D &b, const Normal3D &n) :
            x(t), y(b), z(n) { }
        CUDA_DEVICE_FUNCTION CUDA_INLINE ReferenceFrame(const Normal3D &zz) : z(zz) {
            z.makeCoordinateSystem(&x, &y);
        }

        CUDA_DEVICE_FUNCTION CUDA_INLINE Vector3D toLocal(const Vector3D &v) const {
            return Vector3D(dot(x, v), dot(y, v), dot(z, v));
        }
        CUDA_DEVICE_FUNCTION CUDA_INLINE Vector3D fromLocal(const Vector3D &v) const {
    ...
    struct SurfacePoint {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE float calcSquaredDistance(const Point3D &shadingPoint) const {
            return atInfinity ? 1.0f : sqDistance(position, shadingPoint);
        }
        CUDA_DEVICE_FUNCTION CUDA_INLINE Vector3D calcDirectionFrom(const Point3D &shadingPoint, float* dist2) const {
            if (atInfinity) {
                *dist2 = 1.0f;
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE Vector3D toLocal(const Vector3D &vecWorld) const {
            return shadingFrame.toLocal(vecWorld);
        }
        CUDA_DEVICE_FUNCTION CUDA_INLINE Vector3D fromLocal(const Vector3D &vecLocal) const {
            return shadingFrame.fromLocal(vecLocal);
        }
        CUDA_DEVICE_FUNCTION CUDA_INLINE float calcCosTerm(const Vector3D &vecWorld) const {
    ...
    struct DirectionType {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType LowFreq() { return IE_LowFreq; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType HighFreq() { return IE_HighFreq; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType Delta0D() { return IE_Delta0D; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType Delta1D() { return IE_Delta1D; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType NonDelta() { return IE_NonDelta; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType Delta() { return IE_Delta; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType AllFreq() { return IE_AllFreq; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType Reflection() { return IE_Reflection; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType Transmission() { return IE_Transmission; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType Emission() { return IE_Emission; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType Acquisition() { return IE_Acquisition; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType WholeSphere() { return IE_WholeSphere; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType All() { return IE_All; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType Dispersive() { return IE_Dispersive; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType LowFreqReflection() { return IE_LowFreqReflection; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType LowFreqTransmission() { return IE_LowFreqTransmission; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType LowFreqScattering() { return IE_LowFreqScattering; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType HighFreqReflection() { return IE_HighFreqReflection; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType HighFreqTransmission() { return IE_HighFreqTransmission; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType HighFreqScattering() { return IE_HighFreqScattering; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType Delta0DReflection() { return IE_Delta0DReflection; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType Delta0DTransmission() { return IE_Delta0DTransmission; };
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DirectionType Delta0DScattering() { return IE_Delta0DScattering; };

        InternalEnum value;

        CUDA_DEVICE_FUNCTION CUDA_INLINE DirectionType() { }
        CUDA_DEVICE_FUNCTION CUDA_INLINE constexpr DirectionType(InternalEnum v) : value(v) { }
        CUDA_DEVICE_FUNCTION CUDA_INLINE DirectionType operator&(const DirectionType &r) const { return (InternalEnum)(value & r.value); }
        CUDA_DEVICE_FUNCTION CUDA_INLINE DirectionType operator|(const DirectionType &r) const { return (InternalEnum)(value | r.value); }
        CUDA_DEVICE_FUNCTION CUDA_INLINE DirectionType &operator&=(const DirectionType &r) { value = (InternalEnum)(value & r.value); return *this; }
        CUDA_DEVICE_FUNCTION CUDA_INLINE DirectionType &operator|=(const DirectionType &r) { value = (InternalEnum)(value | r.value); return *this; }
        CUDA_DEVICE_FUNCTION CUDA_INLINE DirectionType flip() const { return InternalEnum(value ^ IE_WholeSphere); }
        CUDA_DEVICE_FUNCTION CUDA_INLINE operator bool() const { return value; }
        CUDA_DEVICE_FUNCTION CUDA_INLINE bool operator==(const DirectionType &r) const { return value == r.value; }
        CUDA_DEVICE_FUNCTION CUDA_INLINE bool operator!=(const DirectionType &r) const { return value != r.value; }

        CUDA_DEVICE_FUNCTION CUDA_INLINE bool matches(DirectionType t) const { uint32_t res = value & t.value; return (res & IE_WholeSphere) && (res & IE_AllFreq); }
        CUDA_DEVICE_FUNCTION CUDA_INLINE bool hasNonDelta() const { return value & IE_NonDelta; }
        CUDA_DEVICE_FUNCTION CUDA_INLINE bool hasDelta() const { return value & IE_Delta; }
        CUDA_DEVICE_FUNCTION CUDA_INLINE bool isDelta() const { return (value & IE_Delta) && !(value & IE_NonDelta); }
        CUDA_DEVICE_FUNCTION CUDA_INLINE bool isReflection() const { return (value & IE_Reflection) && !(value & IE_Transmission); }
        CUDA_DEVICE_FUNCTION CUDA_INLINE bool isTransmission() const { return !(value & IE_Reflection) && (value & IE_Transmission); }
        CUDA_DEVICE_FUNCTION CUDA_INLINE bool isDispersive() const { return value & IE_Dispersive; }
    };
    ...
    struct SurfaceLightPosSample {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE SurfaceLightPosSample() {}
        CUDA_DEVICE_FUNCTION CUDA_INLINE SurfaceLightPosSample(float uEl, float uPos0, float uPos1) :
    ...
    public:
        CUDA_DEVICE_FUNCTION CUDA_INLINE SurfaceLight() {}
        CUDA_DEVICE_FUNCTION CUDA_INLINE SurfaceLight(
    ...
    struct EDFQuery {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE EDFQuery(DirectionType filter, const WavelengthSamples &wls) :
            dirTypeFilter(filter), wlHint(wls.selectedLambdaIndex()) {}
        CUDA_DEVICE_FUNCTION CUDA_INLINE EDFQuery(DirectionType filter, uint32_t _wlHint) :
    ...
    struct EDFSample {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE EDFSample() {}
        CUDA_DEVICE_FUNCTION CUDA_INLINE EDFSample(float uComp, float uDir0, float uDir1) :
    ...
    struct EDFQueryResult {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE EDFQueryResult() {}
    };
    ...
    struct BSDFQuery {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE BSDFQuery(
    ...
    struct BSDFSample {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE BSDFSample() {}
        CUDA_DEVICE_FUNCTION CUDA_INLINE BSDFSample(float uComp, float uDir0, float uDir1) :
            uComponent(uComp), uDir{ uDir0, uDir1 } {}
    };
    ...
    struct BSDFQueryResult {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE BSDFQueryResult() {}
    };
    ...
    struct LensPosSample {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE LensPosSample() {}
        CUDA_DEVICE_FUNCTION CUDA_INLINE LensPosSample(float uPos0, float uPos1) :
            uPos{ uPos0, uPos1 } {}
    };
    ...
    public:
        CUDA_DEVICE_FUNCTION CUDA_INLINE Camera() {}
        CUDA_DEVICE_FUNCTION CUDA_INLINE Camera(ProgSigCamera_sample progSample) :
            m_progSample(progSample) {
        }
    ...
    struct IDFSample {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE IDFSample(float uDir0, float uDir1) :
            uDir{ uDir0, uDir1 } {}
    };
    ...
    struct SceneBounds {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE SceneBounds() {}
    };
...
#if defined(VLR_Device) || defined(OPTIXU_Platform_CodeCompletion)
    template <typename T>
    CUDA_DEVICE_FUNCTION CUDA_INLINE CUDA_INLINE T calcNode(
        ShaderNodePlug plug, const T &defaultValue,
...
#undef VLR_DEFINE_CASE
    ...
    CUDA_DEVICE_FUNCTION CUDA_INLINE CUDA_INLINE SampledSpectrum calcNode(
        ShaderNodePlug plug, const TripletSpectrum &defaultValue,
        const SurfacePoint &surfPt, const WavelengthSamples &wls) {
        if (plug.isValid()) {
            int32_t programID = plp.nodeProcedureSetBuffer[plug.nodeType].progs[plug.plugType];
...
#undef VLR_DEFINE_CASE
    ...
    CUDA_DEVICE_FUNCTION CUDA_INLINE CUDA_INLINE float computeRegularizationFactor(float* cosEpsilon) {
