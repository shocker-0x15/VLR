...
namespace VLR {
    ...
    __constant__ HOST_STATIC_CONSTEXPR float mat_Rec709_D65_to_XYZ[] = {
        0.4124564, 0.2126729, 0.0193339,
        0.3575761, 0.7151522, 0.1191920,
        0.1804375, 0.0721750, 0.9503041,
    };
    __constant__ HOST_STATIC_CONSTEXPR float mat_XYZ_to_Rec709_D65[] = {
        3.2404542, -0.9692660, 0.0556434,
        -1.5371385 , 1.8760108, -0.2040259,
        -0.4985314, 0.0415560, 1.0572252,
    };
    __constant__ HOST_STATIC_CONSTEXPR float mat_Rec709_E_to_XYZ[] = {
        0.4969, 0.2562, 0.0233,
        0.3391, 0.6782, 0.1130,
        0.1640, 0.0656, 0.8637,
    };
    __constant__ HOST_STATIC_CONSTEXPR float mat_XYZ_to_Rec709_E[] = {
