...
namespace VLR {
    ...
    RT_VARIABLE static HOST_CONSTEXPR float mat_Rec709_D65_to_XYZ[] = {
        0.4124564, 0.3575761, 0.1804375,
        0.2126729, 0.7151522, 0.0721750,
        0.0193339, 0.1191920, 0.9503041,
    };
    RT_VARIABLE static HOST_CONSTEXPR float mat_XYZ_to_Rec709_D65[] = {
        3.2404542, -1.5371385, -0.4985314,
        -0.9692660, 1.8760108, 0.0415560,
        0.0556434, -0.2040259, 1.0572252,
    };
    RT_VARIABLE static HOST_CONSTEXPR float mat_Rec709_E_to_XYZ[] = {
        0.4969, 0.3391, 0.1640,
        0.2562, 0.6782, 0.0656,
        0.0233, 0.1130, 0.8637,
    };
    RT_VARIABLE static HOST_CONSTEXPR float mat_XYZ_to_Rec709_E[] = {
