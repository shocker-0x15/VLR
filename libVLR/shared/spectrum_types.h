...
namespace vlr {
    ...
    struct WavelengthSamplesTemplate {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE static WavelengthSamplesTemplate createWithEqualOffsets(RealType offset, RealType uLambda, RealType* PDF) {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr uint32_t NumComponents() { return NumSpectralSamples; }
    };
    ...
    struct SampledSpectrumTemplate {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE bool allPositiveFinite() const {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr uint32_t NumComponents() { return NumSpectralSamples; }
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr SampledSpectrumTemplate Zero() { return SampledSpectrumTemplate(0.0); }
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr SampledSpectrumTemplate One() { return SampledSpectrumTemplate(1.0); }
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr SampledSpectrumTemplate Inf() { return SampledSpectrumTemplate(VLR_INFINITY); }
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr SampledSpectrumTemplate NaN() { return SampledSpectrumTemplate(VLR_NAN); }
    };

    template <typename RealType, uint32_t NumSpectralSamples>
    CUDA_DEVICE_FUNCTION CUDA_INLINE constexpr SampledSpectrumTemplate<RealType, NumSpectralSamples> min(const SampledSpectrumTemplate<RealType, NumSpectralSamples> &value, RealType minValue) {
    ...
    template <typename RealType, uint32_t NumSpectralSamples>
    CUDA_DEVICE_FUNCTION CUDA_INLINE constexpr SampledSpectrumTemplate<RealType, NumSpectralSamples> max(const SampledSpectrumTemplate<RealType, NumSpectralSamples> &value, RealType maxValue) {
        SampledSpectrumTemplate<RealType, NumSpectralSamples> ret;
        for (int i = 0; i < NumSpectralSamples; ++i)
    ...
    template <typename RealType, uint32_t NumSpectralSamples>
    CUDA_DEVICE_FUNCTION CUDA_INLINE constexpr SampledSpectrumTemplate<RealType, NumSpectralSamples> lerp(const SampledSpectrumTemplate<RealType, NumSpectralSamples> &v0, const SampledSpectrumTemplate<RealType, NumSpectralSamples> &v1, RealType t) {
        return (1 - t) * v0 + t * v1;
    }
...
#define UPSAMPLED_CONTINOUS_SPECTRUM_SCALE_FACTOR (0.009355121400914532) // corresponds to cancel dividing by EqualEnergyReflectance.
    ...
    class UpsampledSpectrumTemplate {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE void computeAdjacents(RealType u, RealType v);
#elif SPECTRAL_UPSAMPLING_METHOD == JAKOB_SPECTRAL_UPSAMPLING
    public:
        struct PolynomialCoefficients {
            float c0, c1, c2;

            CUDA_DEVICE_FUNCTION CUDA_INLINE friend PolynomialCoefficients operator*(RealType s, const PolynomialCoefficients &v) {
                return PolynomialCoefficients{ s * v.c0, s * v.c1, s * v.c2 };
            }
            CUDA_DEVICE_FUNCTION CUDA_INLINE PolynomialCoefficients operator+(const PolynomialCoefficients &v) const {
    ...
    private:
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE void interpolateCoefficients(RealType e0, RealType e1, RealType e2, const PolynomialCoefficients* table);
#endif

    public:
#if SPECTRAL_UPSAMPLING_METHOD == MENG_SPECTRAL_UPSAMPLING
        CUDA_DEVICE_FUNCTION CUDA_INLINE UpsampledSpectrumTemplate(RealType u, RealType v, RealType scale) {
            computeAdjacents(u, v);
            m_scale = scale;
        }
        CUDA_DEVICE_FUNCTION CUDA_INLINE constexpr UpsampledSpectrumTemplate(
            SpectrumType spType, ColorSpace space, RealType e0, RealType e1, RealType e2);
#elif SPECTRAL_UPSAMPLING_METHOD == JAKOB_SPECTRAL_UPSAMPLING
        CUDA_DEVICE_FUNCTION CUDA_INLINE UpsampledSpectrumTemplate(SpectrumType spType, ColorSpace space, RealType e0, RealType e1, RealType e2);
#endif
        CUDA_DEVICE_FUNCTION CUDA_INLINE UpsampledSpectrumTemplate() {}

        CUDA_DEVICE_FUNCTION CUDA_INLINE SampledSpectrumTemplate<RealType, NumSpectralSamples> evaluate(const WavelengthSamplesTemplate<RealType, NumSpectralSamples> &wls) const;
...
#   endif
    ...
    public:
        CUDA_DEVICE_FUNCTION CUDA_INLINE RegularSampledSpectrumTemplate(RealType minLambda, RealType maxLambda, const RealType* values, uint32_t numSamples) :
    ...
    public:
        CUDA_DEVICE_FUNCTION CUDA_INLINE IrregularSampledSpectrumTemplate(const RealType* lambdas, const RealType* values, uint32_t numSamples) :
    ...
    public:
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE constexpr DiscretizedSpectrumTemplate(RealType v = 0.0f) :
            values{ v, v, v, v, v, v, v, v, v, v, v, v, v, v, v, v } {}
        CUDA_DEVICE_FUNCTION CUDA_INLINE constexpr DiscretizedSpectrumTemplate(const RealType* vals) : 
        ...
        template <uint32_t N>
        CUDA_DEVICE_FUNCTION CUDA_INLINE constexpr DiscretizedSpectrumTemplate(const WavelengthSamplesTemplate<RealType, N> &wls,
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE DiscretizedSpectrumTemplate operator+() const { return *this; }
        CUDA_DEVICE_FUNCTION CUDA_INLINE DiscretizedSpectrumTemplate operator-() const {
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE DiscretizedSpectrumTemplate operator+(const DiscretizedSpectrumTemplate &c) const {
            RealType vals[NumStrataForStorage];
            for (int i = 0; i < NumStrataForStorage; ++i)
                vals[i] = values[i] + c.values[i];
            return DiscretizedSpectrumTemplate(vals);
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE DiscretizedSpectrumTemplate operator*(RealType s) const {
            RealType vals[NumStrataForStorage];
            for (int i = 0; i < NumStrataForStorage; ++i)
                vals[i] = values[i] * s;
            return DiscretizedSpectrumTemplate(vals);
        }
        CUDA_DEVICE_FUNCTION CUDA_INLINE friend DiscretizedSpectrumTemplate operator*(RealType s, const DiscretizedSpectrumTemplate &c) {
            RealType vals[NumStrataForStorage];
            for (int i = 0; i < NumStrataForStorage; ++i)
                vals[i] = c.values[i] * s;
            return DiscretizedSpectrumTemplate(vals);
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE DiscretizedSpectrumTemplate &operator+=(const DiscretizedSpectrumTemplate &c) {
            for (int i = 0; i < NumStrataForStorage; ++i)
                values[i] += c.values[i];
            return *this;
        }
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE DiscretizedSpectrumTemplate &operator*=(RealType s) {
            for (int i = 0; i < NumStrataForStorage; ++i)
                values[i] *= s;
            return *this;
        }

        CUDA_DEVICE_FUNCTION CUDA_INLINE bool operator==(const DiscretizedSpectrumTemplate &c) const {
            for (int i = 0; i < NumStrataForStorage; ++i)
                if (values[i] != c.values[i])
                    return false;
            return true;
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE void toXYZ(RealType XYZ[3]) const;

        template <uint32_t N>
        CUDA_DEVICE_FUNCTION CUDA_INLINE DiscretizedSpectrumTemplate &add(const WavelengthSamplesTemplate<RealType, N> &wls, const SampledSpectrumTemplate<RealType, N> &val) {
            const RealType recBinWidth = NumStrataForStorage / (WavelengthHighBound - WavelengthLowBound);
            for (int i = 0; i < N; ++i) {
                uint32_t sBin = ::vlr::min<uint32_t>((wls[i] - WavelengthLowBound) / (WavelengthHighBound - WavelengthLowBound) * NumStrataForStorage, NumStrataForStorage - 1);
                values[sBin] += val[i] * recBinWidth;
        ...
        template <uint32_t N>
        CUDA_DEVICE_FUNCTION CUDA_INLINE void atomicAdd(const WavelengthSamplesTemplate<RealType, N> &wls, const SampledSpectrumTemplate<RealType, N> &val) {
            const RealType recBinWidth = NumStrataForStorage / (WavelengthHighBound - WavelengthLowBound);
            for (int i = 0; i < N; ++i) {
                uint32_t sBin = ::vlr::min<uint32_t>((wls[i] - WavelengthLowBound) / (WavelengthHighBound - WavelengthLowBound) * NumStrataForStorage, NumStrataForStorage - 1);
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr uint32_t NumStrata() { return NumStrataForStorage; }
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DiscretizedSpectrumTemplate Zero() { return DiscretizedSpectrumTemplate(0.0f); }
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DiscretizedSpectrumTemplate One() { return DiscretizedSpectrumTemplate(1.0f); }
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DiscretizedSpectrumTemplate Inf() { return DiscretizedSpectrumTemplate(VLR_INFINITY); }
        CUDA_DEVICE_FUNCTION CUDA_INLINE static constexpr DiscretizedSpectrumTemplate NaN() { return DiscretizedSpectrumTemplate(VLR_NAN); }
        ...
        struct CMF {
            ...
            CUDA_DEVICE_FUNCTION CUDA_INLINE const RealType &operator[](uint32_t index) const {
                return values[index];
            }
        };
    ...
    public:
        CUDA_DEVICE_FUNCTION CUDA_INLINE SpectrumStorageTemplate(const ValueType &v = ValueType::Zero()) : value(v) {}
        ...
        template <uint32_t N>
        CUDA_DEVICE_FUNCTION CUDA_INLINE SpectrumStorageTemplate &add(const WavelengthSamplesTemplate<RealType, N> &wls, const SampledSpectrumTemplate<RealType, N> &val) {
            const RealType recBinWidth = NumStrataForStorage / (WavelengthHighBound - WavelengthLowBound);
        ...
        CUDA_DEVICE_FUNCTION CUDA_INLINE SpectrumStorageTemplate &add(const ValueType &val) {
            value += val;
            return *this;
        }

        CUDA_DEVICE_FUNCTION CUDA_INLINE const CompensatedSum<ValueType> &getValue() const {
            return value;
        }
        CUDA_DEVICE_FUNCTION CUDA_INLINE CompensatedSum<ValueType> &getValue() {
            return value;
        }
    };
